...
@section('content')
    <div class="min-vh-100 d-flex align-items-center justify-content-center"
        ...
        <div class="card shadow-lg p-4" style="width: 100%; max-width: 400px; border-radius: 1.5rem;">
            <h2 class="text-center mb-4 text fw-bold" style="color: #640D5F;">Halaman Login</h2>
            ...
            <p class="text-center mt-4 small text-muted">
                Belum punya akun?
                <a href="{{route('register')}}" class="text-decoration-none text-danger fw-semibold">Daftar Sekarang</a>
            </p>
        </div>
    </div>
@endsection
